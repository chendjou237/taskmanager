...
@immutable
class TaskTheme extends ThemeExtension<TaskTheme> {
  const TaskTheme({
  ...
  @override
  ThemeExtension<TaskTheme> copyWith({
    Color? primaryColor,
    Color? tertiaryColor,
    Color? neutralColor,
  }) =>
  ...
  @override
  TaskTheme lerp(
    covariant ThemeExtension<TaskTheme>? other,
    double t,
  ) {
    if (other is! TaskTheme) return this;
    return TaskTheme(
